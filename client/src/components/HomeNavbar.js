...
const HomeNavbar = ({
	...
	useEffect(() => {
		const result = notifications.filter(item => item.readAt === null).length;
		setCount(result);
	}, [notifications]);
			...
			<li className='nav-item p-2'>
				<div className='dropdown '>
					<button
						...
						data-target='#'
					>
						<i className='fa fa-bell text-primary position-relative'>
	...
	return (
		<nav className='navbar py-3 fixed-top navbar-expand-lg navbar-dark scrolling-navbar'>
